...
import { FaInstagram, FaEnvelopeOpen, FaPhoneAlt } from 'react-icons/fa';
        ...
        <Container>
            ...
            <div className={style.container}>
                    <div className={style.content_holder}>
                        ...
                        <p className={style.insta2}><IconContext.Provider value={{ size: '30px' }}> <FaInstagram/></IconContext.Provider><a className={style.insta}href=""><br /><span className={style.red} ></span></a>  </p>
